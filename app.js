...
function createTodoItem(todo, todoIndex){
    ...
    todoLI.innerHTML = `
                ...
                <label class="custom-checkbox" for="${todoID}">
                    <svg fill="transperent"xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>
                </label>
...
function deleteTodoIteam(todoIndex){
